package com.imooc.lagou.es.service.impl;

import com.imooc.lagou.es.service.PositionService;
import com.imooc.lagou.es.util.DBHelper;
...
public class PositionServiceImpl  implements PositionService {
    ...
    private BulkProcessor getBulkProcessor(RestHighLevelClient client) {
        ...
        try {
            ...
            BulkProcessor.Builder builder = BulkProcessor.builder((Client) bulkConsumer, listener);
